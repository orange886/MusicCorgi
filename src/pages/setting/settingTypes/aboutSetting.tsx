        ...
        <View
            ...
            <ScrollView
                ...
                <ThemeText style={style.content}>
                    ...
                    <LinkText linkTo="https://www.qqccy.cn">
                        这里
                    </LinkText>
                    ，是个人链接，如果要了解后续更新的话，点个关注也行。
                </ThemeText>
                <ThemeText style={style.content}>
                    本软件完全免费，并基于GPL协议开源，仅供学习参考使用，不可用于商业目的。代码地址如下，如果打不开试试把github换成gitee:
                </ThemeText>
                <LinkText linkTo={'https://github.com/orange886/MusicCorgi'}>
                    https://github.com/orange886/MusicCorgi
                </LinkText>
                <ThemeText style={style.content}>
                ...
                <ThemeText style={style.content}>
                    如果你对这款软件有一些建议，无论是设计（自己设计的实在太丑...）、逻辑还是交互；或者有一些bug需要反馈、了解一些最新进展，请移步Github仓库或直接个人主页留言（不一定看得到）。
                </ThemeText>
                <Image
                ...
                <ThemeText style={style.content}>by: 猫头猫 & orange</ThemeText>
            </ScrollView>
        </View>
    );
}
